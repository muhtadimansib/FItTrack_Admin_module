...
//     try {
//       const res = await fetch('http://localhost:3000/admin/performance/AllNutritionists');
...
//                     {typeof n.averageRating === 'number' ? n.averageRating.toFixed(1) : "NA"}
//                   </span>
...
export default function NutritionistsTab() {
  ...
  const handleExportPDF = async (nutritionistId: number) => {
    ...
    try {
      const res = await fetch(`http://localhost:3000/admin/performance/nutritionist/${nutritionistId}/pdf?path=exports`);
