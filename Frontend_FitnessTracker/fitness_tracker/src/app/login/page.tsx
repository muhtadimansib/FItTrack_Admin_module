...
//     >
//       {/* Navigation Bar */}
//       <nav className="relative w-full px-6 md:px-10 py-4 flex items-center justify-between bg-black/80 shadow-md">
//         {/* Logo Left */}
//         <div className="flex items-center space-x-3 z-10">
//           <Dumbbell className="text-green-500 w-8 h-8" />
//           <span className="text-3xl font-bold" style={{ fontFamily: "Segoe UI, sans-serif" }}>
//             FitTrack
//           </span>
//         </div>
...
//         {/* Center Menu */}
//         <div
//           className="absolute left-1/2 transform -translate-x-1/2 hidden md:flex items-center text-lg font-medium"
//           style={{ fontFamily: "Segoe UI, sans-serif", fontSize: "24px" }}
//         >
//           <Link href="/" className="px-8 hover:text-green-400 transition">
//             Home
//           </Link>
//           <Link href="/services" className="px-8 hover:text-green-400 transition">
//             Services
//           </Link>
//           <Link href="/about" className="px-8 hover:text-green-400 transition">
//             About
//           </Link>
//           <Link href="/contact" className="px-8 hover:text-green-400 transition">
//             Contact
//           </Link>
//         </div>
//       </nav>
