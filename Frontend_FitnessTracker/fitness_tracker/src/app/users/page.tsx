...
// import { Users, ClipboardList, Dumbbell, Apple } from "lucide-react"; // For top stats
// import { MessageCircle, UserPlus, Bell, AlertCircle } from "lucide-react"; //For notifications
...
//             {/* Main content */}
//           <div
//                 className={`drawer-content flex flex-col p-6 min-h-screen transition-all duration-500 animate-fadeIn ${
...
//                             {profileOpen && (
//                                 <div className={`absolute right-0 mt-2 w-40 text-white rounded-md shadow-lg z-50" ${
...
//                 { icon: <User size={18} />, label: "Users", href: "/users",active: true  },
//                 { icon: <Clock size={18} />, label: "Login activity", href: "#" },
//                 { icon: <BarChart3 size={18} />, label: "Performance", href: "#" },
//                 { icon: <Settings size={18} />, label: "Settings", href: "#" },
//                 { icon: <LogOut size={18} />, label: "Logout", href: "#", danger: true },
//                 ].map((item, idx) => (
//                 <li key={idx}>
//                     <Link
//                     href={item.href}
...
//         {/* Main content */}
//         <div className="text-2xl font-semibold">Users Page Content Here</div>
//       </div>
...
// // Mock user data (30 profiles)
// const users = Array.from({ length: 30 }, (_, i) => ({
//   name: `User ${i + 1}`,
//   email: `user${i + 1}@example.com`,
//   signup: `0${(i % 9) + 1}/0${(i % 12) + 1}/2023`,
//   image: `/images/user${(i % 6) + 1}.jpg`, // Reuse 6 images
// }));
...
//             <label tabIndex={0} className="btn bg-orange-600 text-white hover:bg-orange-700">
//               Clients ▾
//             </label>
//             <ul
//               tabIndex={0}
...
//                     <button className="btn btn-sm bg-green-700 text-white hover:bg-green-800">
//                       See Details
//                     </button>
//                     <button
...
//       <div className="p-6 relative z-0"> {/* ensure root is not clipping dropdown */}
//         <div className="text-3xl font-bold mb-4 slide-fade-in">Users</div>

//         <div className="flex justify-between items-center mb-4 slide-fade-in relative z-10" style={{ animationDelay: "0.1s" }}>
//           <input
//             type="text"
//             placeholder="Search..."
//             className="input input-bordered w-72"
...
//         <div className="mt-4 flex justify-center gap-4 slide-fade-in" style={{ animationDelay: "0.3s" }}>
//           <button
//             className="btn btn-sm"
//             disabled={currentPage === 1}
//             onClick={() => setCurrentPage((p) => p - 1)}
...
// const roles = ["Client", "Trainer", "Nutritionist"];
// const users = Array.from({ length: 30 }, (_, i) => ({
//   name: `User ${i + 1}`,
//   email: `user${i + 1}@example.com`,
//   signup: `0${(i % 9) + 1}/0${(i % 12) + 1}/2023`,
...
//                 type="text"
//                 placeholder="Search..."
//                 className={`w-72 px-4 py-2 rounded-md border focus:outline-none focus:border-orange-500 focus:ring-0.5 focus:ring-orange-500
//                 ${
//                   darkMode
//                     ? "bg-black text-white placeholder-gray-400 border-gray-700"
...
//                   className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-[999] absolute"
//                 >
//                   {["All", "Client", "Trainer", "Nutritionist", "Pending Users"].map(
//                     (role) => (
//                       <li key={role}>
...
//   const handleApprove = () => {
//   // Call backend API or update state as needed
//   console.log("Approving user:");
//   // Example: approveUser(user.id)
// };
...
//                       className={`w-11/12 max-w-4xl p-8 rounded-2xl shadow-xl ${
//                         darkMode ? 'bg-zinc-800 text-white' : 'bg-white text-black'
//                       }`}
//                     >
//                       {/* Header */}
//                       <div className="flex items-center gap-4 border-b pb-6 mb-6">
//                         <div className="w-16 h-16 rounded-full bg-zinc-300 dark:bg-zinc-600 overflow-hidden">
//                           <img
//                             src={selectedUser?.profileImageUrl || "/images/default-avatar.png"}
//                             alt="User"
...
//     <div
//       className={`w-full max-w-lg rounded-xl shadow-2xl pointer-events-auto border ${
...
//   try {
//     setIsSearching(true);
//     const res = await fetch(`http://localhost:3000/admin/search-users?query=${encodeURIComponent(trimmed)}`);
...
//   const response = await fetch("http://localhost:3000/admin/send-bulk", {
//     method: "POST",
//     body: formData,
//   });
...
//     className={`w-full max-w-sm px-4 py-2 border rounded-lg outline-none focus:ring-2 ${
//       darkMode
...
//                   >
//                     <td className="flex items-center gap-3">
//                 {user.image && user.image !== "/images/default.jpg" ? (
//                   <div className="avatar">
...
//       const res = await fetch("http://localhost:3000/admin/send-bulk", {
//         method: "POST",
//         body: formData,
//       });
...
//                     <div
//                       style={{ fontFamily: '"Segoe UI", sans-serif' }}
//                       className={`w-11/12 max-w-2xl p-6 rounded-2xl shadow-xl ${
//                         darkMode ? "bg-zinc-800 text-white" : "bg-white text-black"
//                       }`}
//                     >
...
//                   <div
//                     className={`relative w-11/12 max-w-2xl p-6 rounded-2xl shadow-xl ${
//                       darkMode ? "bg-zinc-800 text-white" : "bg-white text-black"
//                     }`}
//                   >
